...
bool FrontendFlags::InitializeFlags(int argc, char** argv) {
	if (argc < 2) {
...
FrontendFlags::DebugType FrontendFlags::GetDebugType() {
	return flag_debug;
}

string FrontendFlags::GetOutputFile() {
	return flag_output_file;
}

void FrontendFlags::Print() {
	switch (flag_debug) {
	case NO_DEBUGGING:
