...
%token SEMI OPEN_CURLY CLOSE_CURLY COMMA EQUALS_SIGN COLON OPEN_PAREN 
%token CLOSE_PAREN OPEN_SQUARE CLOSE_SQUARE
%token ASTERISK AMPERSAND QUESTION PIPE CARAT LESSER GREATER PLUS MINUS PERCENT
%token FORWARD_SLASH TILDE BANG DOT
